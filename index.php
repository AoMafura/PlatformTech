...
<div class="body container-fluid p-0 bg-dark ">
  ...
  <div class = "col-sm-10 col-md-8 col-lg-6 
    ...
    <h1 class="text-center text-primary mt-5"> Insert Moisture Data Here<h1>
    <div class="mt-4">
      <p class="text-dark text-right mx-5" style="font-size: 15px">
        <i class="far fa-clock"></i> Insert Time Data Here
      </p>
    </div>
    ...
    <div class="col-sm-12 mt-4 mb-5 text-center"> 
      <button class = "bg-primary button p-4 rounded-circle border-0 text-white">
